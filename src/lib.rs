...
impl State {
    pub async fn new(window: Arc<Window>) -> anyhow::Result<Self> {
        ...
        Ok( Self {
            ...
            render_pipeline,
            triangle_in_use: TrinInUse::Trin1,
            vertex_buffer,
            index_buffer,
            num_indices,    
    ...
    fn handle_key(&mut self, event_loop: &ActiveEventLoop, code: KeyCode, is_pressed: bool) {
        match (code, is_pressed) {
            ...
            (KeyCode::Space, true) => {
                ...
                match  self.triangle_in_use {
                    TrinInUse::Trin1 => self.triangle_in_use = TrinInUse::Trin2,
                    TrinInUse::Trin2 => self.triangle_in_use = TrinInUse::Trin1
                }
